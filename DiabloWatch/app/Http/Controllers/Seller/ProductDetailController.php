...
class ProductDetailController extends Controller
{
    ...
    public function index($product_id)
    {
        ...
        return view('seller.product.detail.index', compact('product', 'productDetails'));
    }
    ...
    {
        $product = $this->productService->find($product_id);
        return view('seller.product.detail.create', compact('product'));
    }
    ...
    public function store(Request $request, $product_id)
    {
        ...
        return redirect('seller/product/' . $product_id . '/detail' );
    }
    ...
    public function edit($product_id, $product_detail_id)
    {
        ...
        return view('seller.product.detail.edit', compact('product', 'productDetail'));
    }
