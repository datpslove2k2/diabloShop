                    ...
                    <div class="card-body">
                                ...
                                <ul class="text-nowrap" id="images">
                                    @foreach($productImages as $productImage)
                                        <li class="float-left d-inline-block mr-2 mb-2" style="position: relative; width: 32%;">
                                            <form action="./seller/product/{{ $product->id }}/image/{{ $productImage->id }}" method="post">
                                                @csrf
                                                @method('DELETE')
                                    ...
                                    <li class="float-left d-inline-block mr-2 mb-2" style="width: 32%;">
                                        <form method="post" action="seller/product/{{ $product->id }}/image" enctype="multipart/form-data">
                                            @csrf
                        ...
                        <div class="position-relative row form-group mb-1">
                            <div class="col-md-9 col-xl-8 offset-md-3">
                                <a href="./seller/product/{{ $product->id }}" class="btn-shadow btn-hover-shine btn btn-primary">
